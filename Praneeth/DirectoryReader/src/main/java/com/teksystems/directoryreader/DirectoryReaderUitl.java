...
public class DirectoryReaderUitl {
	...
	public DirectoryReaderUitl(int lenghtOfDirectory, SortFiles sortFiles) {
	...
	public void listAllFilesRecursively(File dir, int tabs) {
		...
		if (dir != null) {
			if (dir.isDirectory()) {
				...
				// sortedList = sort(s);
				List<String> sortedListOfFiles = sortFiles.sortFilesByExtensions(listOfFileNames);
	...
	public static void main(String[] args) {
		...
		SortFiles sf = new SortFilesImpl();
		DirectoryReaderUitl directoryReaderUitl = new DirectoryReaderUitl(directoryFileLength, sf);
